...
import { EvmPayButton } from "./pay-button";
import ChainSelect from "./select";
import { TOKEN_PAY_ADDRESS } from "./tokenPayAddress";
...
const PaymentInUSDT: React.FC = () => {
  ...
  const onSubmitCashier = async (
    sign: (toAddress: string, amount: number) => void
  ) => {
